...
//   - animating width forces NotifCard's internal RowLayout/Text/Flow to
//     re-layout per frame
...
Item {
    ...
    // (same x/y geometry the NotifCard uses for the icon: 14px padding,
    ...
    // Lightweight Rectangles, NOT NotifCards. Each stub is a short strip
    ...
    // Real NotifCards in a normal vertical layout. Crossfaded with the stubs
